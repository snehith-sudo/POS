...
const baseStyles =
  "px-6 py-2 mx-2 rounded-lg text-slate-900 bg-slate-500 transition duration-200 hover:shadow-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed";
