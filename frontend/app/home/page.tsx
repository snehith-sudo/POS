...
export default function page() {
    ...
    const quickActions = [
        { label: "Create Order", href: "/orders", icon: "➕", gradient: "from-slate-800 to-slate-800" },
        { label: "Add Product", href: "/products", icon: "🛒", gradient: "from-slate-800 to-slate-800" },
        { label: "Add Inventory", href: "/inventory", icon: "📦", gradient: "from-slate-800 to-slate-800" },
        { label: "View Clients", href: "/clients", icon: "👨‍💼", gradient: "from-slate-800 to-slate-800" },
        { label: "Sales Report", href: "/reports", icon: "📈", gradient: "from-slate-800 to-slate-800" },
    ];
    ...
    // Root page controls authentication; render dashboard content here.
    return (
